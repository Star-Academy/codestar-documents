...
export class GraphComponent implements OnInit {
    ...
    private initOgma(): void {
        ...
        for (let i = 0; i < this.nodesCount; i++) {
            ...
            this.nodes.push({id: 'n' + i, data: {name: 'Node ' + i}, attributes: {x: randomX, y: randomY, radius: 20}}); // data is a custom dictionary for containing data
        }
        ...
        for (let i = 0; i < this.linksCount; i++) {
            ...
            this.links.push({id: 'e' + i, source: sourceId, target: targetId, data: {name: 'parent'}}); // data is a custom dictionary for containing data
        }
