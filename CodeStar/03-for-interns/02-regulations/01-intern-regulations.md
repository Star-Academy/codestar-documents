...
اطلاع رسانی‌های بوت‌کمپ از طریق **کانال و گروه در پیام رسان تلگرام و سروش+** انجام میشه. توصیه می‌کنیم اطلاع‌رسانی‌ها رو
هم
هر روز چک کنید تا چیزی رو از دست ندید! (لینک گروه تلگرام در روز افتتاحیه باهاتون به اشتراک گذاشته میشه.)
...
نقض این موارد، از مصادیق مشکلات منابع انسانی در جدول امتیاز تلقی شده و باعث دریافت اخطار میشه. (تعداد اخطار‌های ناشی از
مشکلات منابع انسانی، حداکثر 3 بار است و پس از آن کمیته‌ای برای ادامه یا عدم ادامه ی مسیر شما در کداستار برگزار می‌شود)
...
حضور در این جلسات الزامیه و حداکثر ۲ بار می‌تونید غیبت داشته باشید. علاوه بر این، حضور فعال در کارگاه امتیاز مثبت دارد!
...
| ریویو کردن پروژه تیم دیگر   | به جز برخی‌ فاز‌ها، لازم است تا پروژه حداقل یک تیم دیگر را ریویو کنید.    |
| مشکلات منابع انسانی         | امتیاز منفی محسوب شده و در صورت 3 بار تکرار، منجر به خروج از دوره می‌شود. |

امتیازی‌ها

| اسم                    | حداکثر تعداد         | امتیاز واحد | امتیاز کل |
|------------------------|----------------------|-------------|-----------|
| ریویو اضافه            | 4                    | 15          | 60        |
| بهبود مستندات دوره     | 12                   | 5           | 60        |
| فعالیت در کارگاه       | 5 به صلاحدید منتور   | 10          | 50        |
| کمک به دیگر اعضای دوره | 6                    | 5           | 30        |
| امتیاز تشویقی          | بنا بر صلاحدید منتور | 0-50        | 50        |

_مجموع امتیازات: 250_
