...
به بوت‌کمپ کارآموزی مهیمن خوش اومدید!
از اونجایی که قراره با هم هم‌مسیر باشیم و در کنار هم یاد بگیریم و رشد کنیم، یه سری موارد رو از ابتدای بوت‌کمپ باهاتون در
میون می‌ذاریم که تعهد بهشون ضروریه و در صورت عمل نکردن بهشون، روند آموزشیمون به مشکل می‌خوره.
ازتون می‌خوایم این موارد رو خوب مطالعه کنید و در طول دوره بهشون پایبند باشید تا بتونیم تجربه خوبی رو برای همدیگه رقم
بزنیم.

# تعهدات عمومی

شرکت در بوت کمپ مثل یک کار **تمام‌وقت** از شما وقت می‌گیره. این یعنی از شنبه تا پنج‌شنبه حدودا باید روزی ۸ ساعت برای
آموزش،
...
اطلاع رسانی‌های بوت‌کمپ از طریق **کانال و گروه در پیام‌رسان سروش** انجام میشه. توصیه می‌کنیم اطلاع‌رسانی‌ها رو
هم
هر روز چک کنید تا چیزی رو از دست ندید! (لینک گروه سروش در روز افتتاحیه باهاتون به اشتراک گذاشته میشه.)

# حضور در بوت‌کمپ

حضور در بوت‌کمپ، در روزهای **شنبه تا پنج‌شنبه از ساعت 9 صبح الی 17** الزامیه.
...
که
حضور در یک روز خاص برای شما مقدور نبود، **حداکثر تا شب قبل** به منتور خودتون اطلاع بدید.)

# منتورشیپ

یادتون باشه مسئولیت یادگیری و انجام تمرین‌ها به عهده خودتونه و منتور‌ها، مسئولیت دیباگ کدها و خروجی‌های شما رو ندارند؛
بلکه برای به جواب رسیدن، در کنار شما هستند تا چارچوب تفکر یک برنامه‌نویس رو به شما بیاموزند. منتور برای رشد، به شما کمک
و راهنمایی می‌کنه و می‌تونید سوالات خودتون رو ازشون بپرسید.

- منتورینگ در روزهای جمعه و تعطیلات رسمی انجام نمیشه.
- منتور شما تنها در ساعات مشخصی از شبانه روز در دسترسه. بنابراین انتظار نداشته باشید هر لحظه منتور در دسترس باشه.
  ساعت‌های
  در دسترس بودن منتور، در ابتدای بوت‌کمپ، با هماهنگی و همفکری تیم مشخص میشه.

بخش زیادی از یادگیری شما، در تعامل با هم‌تیمی‌ها رخ میده. بنابراین می‌تونید روی کمک هم‌تیمی‌ها حساب کنید. به شرطی که
این
...
نقض این موارد باعث دریافت اخطار میشه. (تعداد اخطار‌های ناشی از
مشکلات منابع انسانی، حداکثر 3 بار است و پس از آن کمیته‌ای برای ادامه یا عدم ادامه ی مسیر شما در کارآموزی مهیمن برگزار می‌شود)
...
- **پروژه و تمرین**، که یک تجربه‌ای در صنعت و کد زدن روی یک پروژه میلیون خطی و همراهی در یک مهاجرت بزرگ در ستاره که به زودی در جریانش قرار خواهی گرفت :)
- **تسک‌ها**، که به نوعی مسیر گام‌به‌گام شما رو تا تموم کردن اون فاز نشون میدن. انجام این اقدامات از این جهت مهمه که
  خودتون
  و منتورها بتونید وضعیت فعلی شما و اینکه چقدر از مطالب رو پیش بردید رو بفهمید.
...
برای افزایش نظم بوت‌کمپ و یادگیری تعهد به ددلاین‌ها، هر فاز ددلاین مشخصی داره و لازم است به ددلاین برسید.

# جلسات روزانه

یکی از نقاط ارتباط شما با منتور‌ها، جلسات روزانه است که در هر روز (از شنبه تا پنج‌شنبه) در ساعت مشخصی از ابتدای روز
...
حضور در این جلسات الزامیه و حداکثر ۲ بار می‌تونید غیبت داشته باشید.

# انجام پروژه

در دنیای مهندسی، کار تیمی یکی از مهم‌ترین مهارتاییه که باید داشته باشیم تا بتونیم به خوبی در این فضا رشد کنیم. برای
همین، مسیر آموزشی شما از همون ابتدای راه به صورت گروهی تنظیم شده و این مسیر رو باید با بقیه افراد طی کنید.
...
در کار تیمی مهارت‌های شما در حوزه‌هایی مثل مسئولیت‌پذیری، تعامل و درک متقابل افزایش پیدا می‌کنه و برای ورود به بازار کار
آماده‌تر می‌شید، پس کار تیمی رو به‌شدت جدی بگیرید.
