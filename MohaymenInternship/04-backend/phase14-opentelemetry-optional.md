...
:::note ‌
این فاز **اختیاری** است.
برای ادامهٔ مسیر یادگیری لازم نیست آن را بخوانید یا انجام دهید.
...
1. در روند ساخت و اجرای query و استفاده از سرویس های مختلف Activity های مورد نیاز را بسازید
2. یک درخواست به API بزنید و در Jaeger مراحل و زمان هر کدام از مراحل را بررسی کنید.
3. در مرحلهٔ ساخت/اجرای query اطلاعات مفید (مثل نام جدول یا خلاصهٔ شرط‌ها) را در Activity ها قرار دهید.

## Logs

1. لاگ برای زمان بالا آمدن، توقف و خاموش شدن سرویس ثبت کنید.
2. برای هر درخواست query، در شروع و پایان لاگ بزنید:
   - در شروع: خلاصهٔ درخواست یا query و TraceId.
   - در پایان: تعداد نتایج و مدت زمان اجرا.
