...
آشنا می‌شوید و در صورت تمایل می‌توانید Mini Query Builder را با این الگو گسترش دهید.
...
در این مرحله به Mini Query Builder خود قابلیتی اضافه کنید که امکان مرتب‌سازی نتیجه را فراهم کند.
...
اگر خواستید، فاز بعد (CI/CD) هم اختیاری است.
