...
-   هدف شما افزایش انگیزه مخاطبان است؟
...
-   در 60 تا 90 ثانیه اول، نه تنها مبحثی که قرار است ارائه دهید، بلکه خودتان را باید معرفی کنید.
...
نکته مهمی که باید در نظر بگیرید این است که از قالبی استفاده کنید که به‌راحتی خوانده شود.
...
-   نتیجه‌گیری کنید (ایده اصلی و برتری‌های آن).
...
-   برای مواقع اضطراری چند نسخه پشتیبان همراه خود داشته باشید (فرمت‌های مختلف مثل PDF یا ذخیره‌سازی ابری).
