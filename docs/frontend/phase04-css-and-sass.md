...
ای که داخل فاز
Dom
ایجاد کردید با استفاده از قابلیت‌های
Nested CSS
و
Mixin
در
...
2. ساختار
   ...
   ایجاد کنید
3. Mixin
   ها را برای کدهای تکراری ایجاد کنید.
4. زیباسازی را با استفاده از مطالبی که در بخش
   Ui/Ux
   یاد گرفتید انجام دهید

#### نکات

-   از ابزارهای مختلف مانند
    Sass preprocessor
    یا
    SCSS compiler
    استفاده کنید.
